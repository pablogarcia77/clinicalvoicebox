  ...
  */
  if ($_SERVER['REQUEST_METHOD'] == 'GET'){
    if (!isset($_GET['id'])){
      ...
      $sql = $dbConn->prepare("SELECT id_patologia,patologia FROM patologias");
      $sql->execute();
      ...
      $sql = $dbConn->prepare("SELECT id_patologia,patologia FROM patologias WHERE id_patologia=:id");
