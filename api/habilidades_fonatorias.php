  ...
  */
  if ($_SERVER['REQUEST_METHOD'] == 'GET'){
    if (!isset($_GET['id'])){
      ...
      $sql = $dbConn->prepare("SELECT id_habilidad,nombre FROM habilidades_fonatorias");
      $sql->execute();
      ...
      $sql = $dbConn->prepare("SELECT id_habilidad,nombre FROM habilidades_fonatorias WHERE id_habilidad=:id");
