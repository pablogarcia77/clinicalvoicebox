  ...
  */
  if ($_SERVER['REQUEST_METHOD'] == 'GET'){
    if(!isset($_GET['id'])){
      ...
      $sql = $dbConn->prepare("SELECT id_profesion as id, profesion FROM profesiones");
      $sql->execute();
      ...
      $sql = $dbConn->prepare("SELECT id_profesion as id, profesion FROM profesiones WHERE id_profesion=:id");
